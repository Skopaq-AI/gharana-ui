...
export const InspectorModal: React.FC<InspectorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#08060d]/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-3xl max-h-[85vh] glass-panel rounded-2xl border border-[#342847] shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
